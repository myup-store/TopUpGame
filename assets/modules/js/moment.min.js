    ...
    if (!t._d) {
      for (
        i = (function (t) {
          ...
          null != t._dayOfYear && ((a = de(t._a[Tt], i[Tt])), (t._dayOfYear > V(a) || 0 === t._dayOfYear) && (d(t)._overflowDayOfYear = !0), (s = J(a, 0, t._dayOfYear)), (t._a[xt] = s.getUTCMonth()), (t._a[bt] = s.getUTCDate())),
          n = 0;
        n < 3 && null == t._a[n];
        ++n
      )
    ...
    if (t._f !== e.ISO_8601)
      if (t._f !== e.RFC_2822) {
        ...
        for (i = R(t._f, t._locale).match(rt) || [], n = 0; n < i.length; n++)
          (r = i[n]),
            (s = (o.match(F(r, t)) || [])[0]) && ((a = o.substr(0, o.indexOf(s))).length > 0 && d(t).unusedInput.push(a), (o = o.slice(o.indexOf(s) + s.length)), (l += s.length)),
                ...
                ? (function (e) {
                    ...
                    for (i = 0; i < e._f.length; i++)
                      (r = 0),
                        ...
                        (t._f = e._f[i]),
                        _e(t),
                        h(t) && ((r += d(t).charsLeftOver), (r += 10 * d(t).unusedTokens.length), (d(t).score = r), (null == s || r < s) && ((s = r), (n = t)));
                    u(e, n || t);
                  })(o)
                : y
                ? _e(o)
  ...
  function xe(e, t) {
    ...
    return (
      Me(e)
        ...
        : (u = fn.exec(e))
        ? ((n = "-" === u[1] ? -1 : 1), (a = { y: 0, d: g(u[bt]) * n, h: g(u[Pt]) * n, m: g(u[Wt]) * n, s: g(u[Ht]) * n, ms: g(Se(1e3 * u[Rt])) * n }))
        : (u = mn.exec(e))
        ? ((n = "-" === u[1] ? -1 : (u[1], 1)), (a = { y: be(u[2], n), M: be(u[3], n), w: be(u[4], n), d: be(u[5], n), h: be(u[6], n), m: be(u[7], n), s: be(u[8], n) }))
        : null == a
        ? (a = {})
        : "object" == typeof a &&
          ("from" in a || "to" in a) &&
  ...
  function We(e, t) {
    return function (n, s) {
      ...
      return (
        null === s ||
          isNaN(+s) ||
          (M(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), (r = n), (n = s), (s = r)),
    ...
    (Dn.utcOffset = function (t, n, s) {
      ...
      if (null != t) {
        ...
        return (
          ...
          (this._isUTC = !0),
          null != i && this.add(i, "m"),
          r !== t && (!n || this._changeInProgress ? He(this, xe(t - r, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), e.updateOffset(this, !0), (this._changeInProgress = null))),
          this
        );
      }
  ...
  (kn.calendar = function (e, t, n) {
    ...
    (kn.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (o(this, "_monthsShortRegex") || (this._monthsShortRegex = Et), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
    }),
    (kn.week = function (e) {
    ...
    (kn.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (o(this, "_weekdaysRegex") || (this._weekdaysRegex = zt), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
    }),
    (kn.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ? (o(this, "_weekdaysRegex") || ee.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        : (o(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $t), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
    }),
    (kn.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ? (o(this, "_weekdaysRegex") || ee.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        : (o(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = qt), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
    }),
    (kn.isPM = function (e) {
