!(function (t) {
  ...
  function n(e, i) {
    ...
    return (
      ...
      this.element.find(this.settings.imageSelector).each(function () {
        s.settings.images.push({ title: t(this).attr("title"), src: t(this).attr(s.settings.imageSource), height: !1, width: !1 });
      }),
  ...
  t.extend(n.prototype, {
    init: function (t) {
      return (
        this.settings.initialized || (this.setDomContainer(), this.markup(), this.events(), (this.settings.lastImage = this.settings.images.length - 1), (this.settings.initialized = !0)),
    ...
    center: function (t, e, i, s, n) {
      return this.elems.content.css("overflow", "visible").animate({ width: t, height: e, left: i, top: s }, n).promise();
    },
    appear: function (t) {
      var e = this;
    ...
    fit: function (e, i) {
      ...
      return (
        "cover" == this.settings.imageSize
          ...
          ? ((s = o), (n = a))
          : (p > u ? ((s = g), (n = s / p)) : ((n = m), (s = n * p)), "default" === this.settings.imageSize && (n >= a || s >= o) && ((n = a), (s = o))),
    ...
    arrows: function () {
      this.settings.loop
        ...
        ? (this.settings.currentImage == this.settings.lastImage ? this.elems.right.removeClass("active") : this.elems.right.addClass("active"),
          0 === this.settings.currentImage ? this.elems.left.removeClass("active") : this.elems.left.addClass("active"))
    ...
    destroy: function () {
      this.element.removeData(),
        ...
        this.settings.initialized &&
          (this.settings.fullscreenOpen && this.exitFullScreen(), (this.settings.currentImage = !1), (this.settings.initialized = !1), this.elems.domContainer.removeClass(this._cssClasses.join(" ")), this.elems.wrapper.remove());
    },
    ...
    markup: function () {
      this.elems.domContainer.addClass("chocolat-open " + this.settings.className),
        ...
        (this.elems.wrapper = t("<div/>", { class: "chocolat-wrapper", id: "chocolat-content-" + this.settings.setIndex }).appendTo(this.elems.domContainer)),
        (this.elems.overlay = t("<div/>", { class: "chocolat-overlay" }).appendTo(this.elems.wrapper)),
        (this.elems.loader = t("<div/>", { class: "chocolat-loader" }).appendTo(this.elems.wrapper)),
        (this.elems.content = t("<div/>", { class: "chocolat-content" }).appendTo(this.elems.wrapper)),
        (this.elems.img = t("<img/>", { class: "chocolat-img", src: "" }).appendTo(this.elems.content)),
        (this.elems.top = t("<div/>", { class: "chocolat-top" }).appendTo(this.elems.wrapper)),
        (this.elems.left = t("<div/>", { class: "chocolat-left" }).appendTo(this.elems.wrapper)),
        (this.elems.right = t("<div/>", { class: "chocolat-right" }).appendTo(this.elems.wrapper)),
        (this.elems.bottom = t("<div/>", { class: "chocolat-bottom" }).appendTo(this.elems.wrapper)),
        (this.elems.close = t("<span/>", { class: "chocolat-close" }).appendTo(this.elems.top)),
        (this.elems.fullscreen = t("<span/>", { class: "chocolat-fullscreen" }).appendTo(this.elems.bottom)),
        (this.elems.description = t("<span/>", { class: "chocolat-description" }).appendTo(this.elems.bottom)),
        (this.elems.pagination = t("<span/>", { class: "chocolat-pagination" }).appendTo(this.elems.bottom)),
        (this.elems.setTitle = t("<span/>", { class: "chocolat-set-title", html: this.settings.setTitle }).appendTo(this.elems.bottom)),
